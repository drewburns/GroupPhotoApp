...
class SignUpViewController: UIViewController ,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let ref = Database.database().reference(fromURL: "https://photo-fcebe.firebaseio.com")
    ...
    @IBAction func create(_ sender: Any) {
        ...
        let refUsers = Database.database().reference(fromURL: "https://photo-fcebe.firebaseio.com").child("users")
